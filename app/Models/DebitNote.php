...
class DebitNote extends Model
{
    ...
    {
        return $this->belongsToMany(Einvoice::class, 'debit_note_einvoice');
    }

    public function consolidatedEinvoice()
    {
        return $this->belongsToMany(ConsolidatedEinvoice::class, 'debit_note_consolidated_einvoice');
    }
    ...
    public function generateSku(): string
    {
        ...
        while (true) {
            ...
            $sku = 'EDN-' . now()->format('ym') . '/' . $str_init_idx;
