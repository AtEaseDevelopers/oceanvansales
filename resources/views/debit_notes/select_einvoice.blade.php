            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('debit-notes.update-einvoice') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary" {{ $einvoices->isEmpty() ? 'disabled' : '' }}>Next: Enter Debit Note Details</button>
